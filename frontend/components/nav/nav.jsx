...
const Nav = (props) => {
    ...
    let logoutButton
    props.currentUser? logoutButton = <button id='logout' onClick={props.logout}>Logout</button> : logoutButton = null
        
    return( 
    <div className="splash-nav">
        <div id="nav-left">
            <svg id='shroomy' version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" space="preserve">
